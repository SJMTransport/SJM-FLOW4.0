...
export default function App() {
  ...
  const handleInvoiceClick = useCallback((inv: any) => {
    const invoiceObj = typeof inv === 'string'
      ? (invoices || []).find((x: any) => x.no_invoice === inv || x.id === inv)
      : inv;
    if (invoiceObj) pushModal("invoice", invoiceObj);
  }, [invoices, pushModal]);
