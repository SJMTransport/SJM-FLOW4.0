        ...
        <main className="flex-1 overflow-y-auto p-3 custom-scrollbar bg-bg relative">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activeModule === "laporan" && <LaporanPage activeSub={activeSub} jurnal={jurnal} coa={coa} so={so} armada={armada} auditLogs={auditLogs} saldoAwal={saldoAwal} onSOClick={handleSOClick} onJurnalClick={handleJurnalClick} />}
      ...
      <AnimatePresence>
        {activeModals.length > 0 && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[1000] flex justify-end backdrop-blur-sm bg-text-main/20 pointer-events-none" 
            onClick={clearModals}
          >
