...
export const ModalShell = ({ children, onClose, isOpen }: any) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-end p-0 bg-white/40 backdrop-blur-sm animate-fade" onClick={onClose}>
...
export const ConfirmModal = ({ open, title, msg, onConfirm, onCancel, confirmLabel = "Hapus", confirmColor = null }: any) => {
  if (!open) return null;
  return (
    <div className="fixed inset-0 bg-white/40 backdrop-blur-sm z-[9000] flex items-center justify-center p-6" onClick={onCancel}>
